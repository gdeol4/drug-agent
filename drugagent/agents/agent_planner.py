...
You do not have any prior knowledge about this problem.  
...
class PlannerAgent(Agent):
    ...
    def __init__(self, args, env, name, early_stopping = 2):
    ...
    def run(self, env):
        ...
        while not env.is_final() and len(self.history_steps) < self.args.planner_max_steps:
        ...
        """
            ...
            rg = entries["Idea Space Management"]
            ...
            entries["Idea Space Management"] = new_research_plan_content
            entries["Idea Space Management"]= new_research_plan_content.replace("**", "")
